...
def extract_waveforms_py(extract_waveforms, session_params, ks_path):
...
if __name__ == '__main__':
	...
	session_params = {
		'root': 'C:/Users/Alejandro/Downloads/aragorn_20240712_g0/',
		# 'root' : '/Users/rahimhashim/Downloads/',
		'monkey': 'aragorn',	 # 'gandalf' | 'aragorn'
		'date': '20240712',		 # 'YYYYMMDD'
	...
	tprime_py(
		...
		imec_folder_dict, 
		ks_path, 
		session_params['monkey'], 
		session_params['date'], 
		session_params['session_num']
		)
	# Extract waveforms
	extract_waveforms = True
	extract_waveforms_py(extract_waveforms, session_params, ks_path)
	# Move Kilosort output files
	src = session_params['root']
	dst = src+'_small'
	move_ks_output(src, dst, max_size_mb=10000)
